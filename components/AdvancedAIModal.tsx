...
export const AdvancedAIModal: React.FC<AdvancedAIModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[2000]">
      <div className="bg-[#1e2329] rounded-lg shadow-xl w-[90vw] max-w-5xl h-[85vh] flex flex-col border border-[#3a3e45] relative">
        ...
        <div className="flex justify-between items-center p-4 border-b border-[#3a3e45]">
          ...
          <button onClick={onClose} className="text-2xl text-[#a0a5b0] hover:text-white">&times;</button>
        </div>

        {/* Tabs */}
        <div className="flex border-b border-[#3a3e45] bg-[#242830]">
          {[
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium transition-colors flex items-center gap-2 ${
                activeTab === tab.id 
                  ? 'bg-[#1e2329] text-[#0084ff] border-t-2 border-[#0084ff]' 
                  : 'text-[#a0a5b0] hover:text-white hover:bg-[#3a3e45]'
              }`}
            >
              <span>{tab.icon}</span>
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6 bg-[#1e2329] custom-scrollbar relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
                    <div className="md:col-span-1 space-y-4 bg-[#242830] p-4 rounded-lg h-fit">
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <button onClick={() => setHelpModalOpen(true)} className="text-[#0084ff] hover:text-white" title="Ajuda">ℹ️</button>
                        </div>
                        
                        <div>
                            <label className="block text-xs font-bold text-[#a0a5b0] mb-1">Início do Projeto</label>
                            <input 
                                type="date" 
                                value={dates.start} 
                        ...
                        <div className="flex gap-2">
                            <div className="flex-1">
                                <label className="block text-xs font-bold text-[#a0a5b0] mb-1">Duração Estimada</label>
                                <input 
                                    type="number" 
                                    value={duration} 
                            ...
                            <div className="w-24">
                                <label className="block text-xs font-bold text-[#a0a5b0] mb-1">Unidade</label>
                                <select 
                                    value={durationUnit}
                        ...
                        <div>
                            <label className="block text-xs font-bold text-[#a0a5b0] mb-1">Fim (Deadline)</label>
                            <input 
                                type="date" 
                                value={dates.end} 
                        ...
                        <div className="mt-4 text-xs text-[#a0a5b0] border-t border-[#3a3e45] pt-3">
                    ...
                    <div className="md:col-span-2 bg-[#242830] p-4 rounded-lg overflow-y-auto max-h-[600px]">
                        ...
                        {result ? (
                            <div>
                                ...
                                <pre className="text-xs text-gray-300 bg-[#1e2329] p-4 rounded overflow-x-auto custom-scrollbar">
                                    {JSON.stringify(result, null, 2)}
                                </pre>
                            </div>
                        ) : (
                            <div className="flex flex-col items-center justify-center h-60 text-[#a0a5b0] border-2 border-dashed border-[#3a3e45] rounded-lg">
                    ...
                    <div className="flex items-end gap-4 bg-[#242830] p-4 rounded-lg">
                        <div className="flex-1">
                            <div className="flex justify-between mb-1">
                                <label className="block text-xs font-bold text-[#a0a5b0]">Data de Corte (Data Date)</label>
                                <button onClick={() => setHelpModalOpen(true)} className="text-[#0084ff] hover:text-white" title="Ajuda">ℹ️</button>
                            </div>
            ...
            {activeTab === 'optimizer' && (
                <div className="h-full flex flex-col">
                    <div className="bg-[#242830] p-4 rounded-lg mb-6 relative">
                        <button onClick={() => setHelpModalOpen(true)} className="absolute top-4 right-4 text-[#0084ff] hover:text-white" title="Ajuda">ℹ️</button>
                        <p className="text-sm text-[#a0a5b0] mb-4 pr-8">
                 ...
                 <div className="h-full flex flex-col">
                     <div className="flex justify-between items-center bg-[#242830] p-4 rounded-lg mb-4 relative">
                        ...
                        <div className="flex gap-2 items-center">
                            <button onClick={() => setHelpModalOpen(true)} className="text-[#0084ff] hover:text-white mr-2" title="Ajuda">ℹ️</button>
                            <Button variant="primary" onClick={handleGenerateReport}>📄 Gerar Relatório</Button>
                        </div>
                     </div>

                     <div className="flex-1 bg-[#1e2329] border border-[#3a3e45] rounded-lg p-6 overflow-y-auto font-mono text-sm text-gray-300 custom-scrollbar">
                        {result ? (
