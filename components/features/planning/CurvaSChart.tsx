        ...
        >
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    ...
                    <div className="flex items-start gap-2">
                        <div className="w-8 h-0.5 bg-red-500 mt-2 flex-shrink-0" style={{ backgroundImage: 'repeating-linear-gradient(to right, #EF4444 0, #EF4444 5px, transparent 5px, transparent 10px)' }}></div>
                        <div>
